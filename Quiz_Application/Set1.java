...
public class Set1 extends javax.swing.JFrame {
    ...
    {"1) The default value of a static integer variable of a class in Java is"
            ,"2) Which of the following statement about the java language is true?"
            ...
            ,"9)The java run time system automatically calls this method while garbage collection."
            ,"10) The correct order of the declarations in a Java program is"};
    String[][] option=
...
"D.None of the Above"},
{"a) static","b)constant","c)Final","d)abstract"},
...
"(c)May be declared private","(d) (a),(b)and(c)}"},
...
"(d)   Class declaration, import statement, package declaration"}};
            ...
            
    {
      ...
      // System.out.println(option[index][4]);
        ...
        if(rbtn.getText().equals(option[0][0]))
        {
         ...
         if(rbtn.getText().equals(option[index][2]))
        {
        ...
        if(rbtn.getText().equals(option[index][3]))
        {
            correct++;
           index++;
        }
        ...
        if(rbtn.getText().equals(option[index][0]))
        {
            correct++;
            index++;
        }
        if(rbtn.getText().equals(option[index][1]))
        {
            correct++;
           index++;
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 320, 90, 40));
        ...
        jPanel1.add(jButton_Next_Q, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 320, 85, 40));
