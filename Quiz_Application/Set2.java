...
import static com.mycompany.firstsem.Set6_1.correct;
...
"(d)   Class declaration, import statement, package declaration"}};
            ...
            
    {
      ...
      // System.out.println(option[index][4]);
        ...
        if(rbtn.getText().equals(option[3][3]))
        {
            correct++;
           index++;
        }
        ...
        if(rbtn.getText().equals(option[5][3]))
        {
            correct++;
           index++;
        }
        ...
        if(rbtn.getText().equals(option[8][1]))
        {
         ...
         if(rbtn.getText().equals(option[9][0]))
        {
            correct++;
            index++;
       }
